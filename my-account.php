...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Mi Cuenta-Administradora</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Comprar</a></li>
                        <li class="breadcrumb-item active">Administradora</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="inventarioSuministro.php"> <i class="fas fa-box-open"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Inventario de Suministros</h4>
                                    <p>Editar inventario de suministros</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="inventarioGallinas.php"><i class="fas fa-feather-alt"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Gallinas</h4>
                                    <p>Editar datos de gallinas.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="inventarioHuevos.php"> <i class="fas fa-egg"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Huevos</h4>
                                    <p>Editar inventario de productos.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="registroClientes.php"> <i class="fas fa-user-edit"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Clientes</h4>
                                    <p>Editar o añadir clientes</p>
                                </div>
                            </div>
                        </div>
                    </div>
