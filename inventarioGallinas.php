...
$consulta = $pdo -> prepare("CALL ConsultarGallinas()");
$consulta -> execute();
$resultadoGallinas = $consulta->fetchAll(PDO::FETCH_ASSOC);
...
$consultaVacunas = $pdo -> prepare("call ObtenerVacunacion()");
$consultaVacunas -> execute();
$resultadoVacunacion = $consultaVacunas->fetchAll(PDO::FETCH_ASSOC);

/*
$queryVacunacion = "call ObtenerVacunacion()";
$resultadoVacunacion = $conexionAbierta -> query($queryVacunacion);
*/
...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Inventario de Gallinas</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Administradora</a></li>
                        <li class="breadcrumb-item active">Gallinas</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="cart-box-main">
        <div class="container">
            <div class="row">
            <button class="btn hvr-hover" style="color: aliceblue;" onclick="location.href='my-account.php'"><i class="fas fa-chevron-left"></i></button>
            <div class="table-main table-responsive">
        <table class="table" id="tablaInventarioSum">
           <thead>
                        <tr>
                            <th >Cantidad de Gallinas</th>
                            <th class="text-center">Edad</th>
                            <th class="text-center">Vacunación</th>   
                            <th class="text-center">Supervisión</th>    
                            <th class="text-center">Lote de Gallinas</th>                                              
                        </tr>
            </thead> 
            <tbody>
            <?php foreach($resultadoGallinas as $ISABrown){ ?>     
                <tr>
                            <td class="name-pr">
                                    <a href="#">
									<?php echo $ISABrown['CANT_GALLINAS'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php echo $ISABrown['EDAD_GALLINAS'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
                                    ...
                                    foreach($resultadoVacunacion as $vacunas){
                                        if($vacunas['Id_Vacunacion'] == $ISABrown['VACUNACION']){
                                            echo $vacunas['Des_Vacunacion'];
                                        }
                                    }
                            ...
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php echo $ISABrown['SUPERVISION'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php echo $ISABrown['LOTE_GALLINAS'] ?>
								    </a>
                            </td>
                </tr>        
        ...
        <button type="submit" class="btn hvr-hover" name="btnInsGallinas" id="btnInsGallinas" style="color: aliceblue; height:50px; width:160px" data-toggle="modal" data-target="#insertarModalGallinas"><i class="fas fa-feather-alt"></i> Ingresar Datos</button>
        <button type="submit" class="btn hvr-hover" name="btnActGallinas" id="btnActGallinas" style="color: aliceblue; height:50px; width:160px" data-toggle="modal" data-target="#actualizarModalGallinas"><i class="fas fa-feather-alt"></i> Actualizar Datos</button>
    </div>               
    ...
    <!-- ALL PLUGINS -->
    <?php require_once "modalActGal.php" ?>
    <?php require_once "modalInsGal.php" ?>
