<?php 
    ...
    if(isset($_POST['btnIniciarSesion']))
    {
        ...
        $Usua = $_POST['InputCedul'];
        $Contra =$_POST['InputPassword'];
        
        $queryUsurio = "call validarUsuario('$Usua','$Contra')";
        $resultadoUsuario = $conexionAbierta -> query($queryUsurio);
     
        //echo $queryUsurio;

        //print_r($resultadoUsuario);

        $filasa = mysqli_num_rows ($resultadoUsuario);
        ...
        if($filasa > 0)
        {
            ...
            $_SESSION["Perfil"] = $usuarioEncontrado["idRol"];
            $_SESSION["DescripcionPerfil"] = $usuarioEncontrado["Descripcion"];
            $_SESSION["NombreUsuario"] = $usuarioEncontrado["Nombre"];
            $_SESSION["cedu"] = $usuarioEncontrado["Cedula"];
    ...
    if(isset($_POST['btnAgregarUsuario']))
    {
        ...
        $queryRegistro = "call RegistrarUsuario('$cedula','$nombre','$apellido1',
        '$correo','$direccion','$contraseña',$rol,$provincia,$telefono,'$apellido2')";

        $resultadoUsuario = $conexionAbierta -> query($queryRegistro);
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            ...
                            if(!empty ($_SESSION["Perfil"] ) &&  $_SESSION["Perfil"] > 0 )
                            {
                                echo '<li><a href=""><i class="fa fa-user s_color"></i> Rol del Usuario</a></li>';
                                echo  "<font color='white'>" . "    " . $_SESSION["DescripcionPerfil"]."</font>";
                            }
        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a data-toggle="collapse" href="#formLogin" role="button" aria-expanded="false">Iniciar Sesión</A></a></h5>
                    <form class="mt-3 collapse review-form-box" id="formLogin" method ="post">
                        <div class="form-row">
                           <div class="form-group col-md-6">
                                <label for="InputCedul" class="mb-0">Cédula </label>
                                <input type="text" class="form-control" id="InputCedul" name="InputCedul" placeholder="Ingrese Cédula"> </div>
                            <div class="form-group col-md-6">
                                <label for="InputPassword" class="mb-0">Contraseña</label>
                                <input type="password" class="form-control" id="InputPassword" name="InputPassword" placeholder="Contraseña"> </div>
                        </div>
                        <button type="submit" class="btn hvr-hover" name="btnIniciarSesion" id="btnIniciarSesion">Ingresar</button>
                    </form>
                </div>
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="title-left">
                    ...
                    <h5><a data-toggle="collapse" href="#formRegister" role="button" aria-expanded="false">Registrese Aquí</a></h5>
                    ...
                    <div class="form-row" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="InputCedula" name="InputCedula"   maxlength="12" placeholder="Cedula" required> 
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="InputName" name="InputName" placeholder="Primer Nombre" required> 
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputPrimerApellido" name="inputPrimerApellido" placeholder="Primer Apellido" > 
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputSegundoApellido" name="inputSegundoApellido" placeholder="Segundo Apellido" > 
                                
                                </div>

                            <div class="form-group col-md-6">
                                <label for="InputEmail1" class="mb-0">Email *</label>
                                <input type="email" class="form-control" id="InputEmail1" name="InputEmail1" placeholder="Digite su correo" required> 
                                <div class="invalid-feedback"> Ingrese una dirección de correo electrónico valida</div>
                                </div>
                            
                            <div class="form-group col-md-6">
                                <label for="address">Dirección *</label>
                                <input type="text" class="form-control" id="address" name="address" placeholder="Digite la dirección" >
                                
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="InputTelefono">Telefono</label>
                                <input type="text" class="form-control" id="InputTelefono" name="InputTelefono" placeholder="Digite el numero de telefono" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" id="InputPassword1" name= "InputPassword1"placeholder="Contraseña" required> </div>
                        </div>
                        
                        <button type="submit" class="btn hvr-hover" name="btnAgregarUsuario" id="btnAgregarUsuario">Registrarse</button>
