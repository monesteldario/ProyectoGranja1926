...
$consulta = $pdo -> prepare("CALL ConsultaSuministros()");
$consulta -> execute();
$resultadoProveedor = $consulta->fetchAll(PDO::FETCH_ASSOC);
...
<div class="cart-box-main">
    ...
    <div class="table-main table-responsive">
        <table class="table" id="tablaInventarioSum">
           <thead>
                        <tr>
                            ...
                            <th class="text-center">Cantidad de Alimentos</th>
                            <th class="text-center">Cantidad de Vacunas</th>   
            ...
            <?php foreach($resultadoProveedor as $proveedor){ ?>     
                <tr>
                            <td class="name-pr">
                                    <a type="text" href="actualizarPaciente.php?cedEmpresa='. $proveedor['CED_EMPRESA'] . '">
									<?php echo $proveedor['CED_EMPRESA'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a type="text" href="#">
									<?php echo $proveedor['NOM_EMPRESA'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php 
                                        if(!empty($proveedor['CANT_ALIMENTOS'])){
                                            echo $proveedor['CANT_ALIMENTOS'];
                                            echo '  Quintales';
                                        }else{
                                            echo '-';
                                        }
                            ...
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php 
                                        if(!empty($proveedor['CANT_VACUNAS'])){
                                            echo $proveedor['CANT_VACUNAS'];
                                            echo '  Dosis';
                                        }else{
                                            echo '-';
                                        }                                
        ...
        <button type="submit" class="btn hvr-hover" name="btnActSuministro" id="btnActSuministro" style="color: aliceblue; height:50px; width:150px" data-toggle="modal" data-target="#insertarModalSuministro"><i class="fas fa-id-card"></i> Añadir Proveedor</button>
        <button type="submit" class="btn hvr-hover" name="btnActSuministro" id="btnActSuministro" style="color: aliceblue; height:50px; width:165px" data-toggle="modal" data-target="#actualizarModalSuministro"><i class="fas fa-id-card"></i> Actualizar Proveedor</button>
    </div>             
            </div>
        </div>
    </div>
    ...
    <!-- ALL PLUGINS -->
    <?php require_once "modalActSum.php" ?>
    <?php require_once "modalInsSum.php" ?>
