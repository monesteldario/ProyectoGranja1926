        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="needs-validation"  action="pagar.php" method="post">
                        <label for="cc-expiration">Complete los campos para realizar su compra:</label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="invalid-feedback"> ¡Ingrese un correo válido para contactarnos con usted! </div>
                            </div>
                            <div class="mb-3">
                                <label for="address">Dirección 1 *</label>
                                <input type="text" class="form-control" id="address" placeholder="" required>
                                <div class="invalid-feedback"> ¡Digite una dirección válida! </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-5 mb-3">
									...
									<option value="Choose..." data-display="Select">Seleccione...</option>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="invalid-feedback"> Zip requerido </div>
                                </div>
                            </div>
                            <hr class="mb-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="same-address">
                                <label class="custom-control-label" for="same-address">Dirección de entrega es la misma que la del pedido</label>
                            </div>
                            <hr class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="payment-icon"> <span>Recibimos sus tarjetas:</span>
                                        <ul>
                            ...
                            <div class="col-sm-6 col-lg-6 mb-3">
                            <div class="row">
                                <button class="col-12 d-flex shopping-box " type="submit" value="proceder" name="compra">Realizar Pedido</button>
                                <!--<div > <a href="" class="ml-auto btn hvr-hover"></a> </div>-->
                    </form>
