...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Inventario de Huevos</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Administradora</a></li>
                        <li class="breadcrumb-item active">Huevos</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="cart-box-main">
        ...
        <table class="table" id="tablaInventarioH">
           <thead>
                        <tr>
            ...
            <?php foreach($resultadoProducto as $huevos){ ?>     
                <tr>
                            <td class="name-pr">                                        
                                    <a href="#">
									<?php echo $huevos['IDPRESEN'] ?>
								    </a>                                                                                                                                                         
                            </td>
                            <td class="name-pr">
                                    <a href="#">
									<?php echo $huevos['NOM_PRESEN'] ?>
								    </a>
                            </td>
                            <td class="name-pr">
                                    <a href="#">
									<?php echo $huevos['PRECIO'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php echo $huevos['CANT_PRESEN'] ?>
								    </a>
                            </td>
                </tr>        
        ...
        <button type="submit" class="btn hvr-hover" name="btnActSuministro" id="btnActSuministro" 
        style="color: aliceblue; height:50px; width:185px" data-toggle="modal" data-target="#actualizarModal">
        <i class="fas fa-edit"></i> Actualizar Presentación</button>
        </div>
        </div>
        </div>
    </div>
