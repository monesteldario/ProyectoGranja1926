...
$consulta = $pdo -> prepare("CALL ConsultaClientes()");
$consulta -> execute();
...
<body>
    ...
    <div class="cart-box-main">
        ...
        <table class="table" id="tablaInventarioSum">
           <thead>
                        <tr>
                            ...
                            <th class="text-center">Entregas Semanales</th>                                                 
                        </tr>
            </thead> 
            <tbody>
            <?php foreach($clientes as $clie){ ?>     
                <tr>
                            <td class="name-pr">
                                    <a href="#">
									<?php echo $clie['ID_CLIENTE'] ?>
								    </a>
                            </td>
                            <td class="name-pr">
                                    <a href="#">
									<?php echo $clie['CED_CLIENTE'] ?>
								    </a>
                            </td>
                            <td class="name-pr">
                                    <a href="#">
									<?php echo $clie['NOM_CLIENTE'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php echo $clie['TEL_CLIENTE'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php echo $clie['DIREC_CLIENTE'] ?>
								    </a>
                            </td>
                            <td class="name-pr text-center">
                                    <a href="#">
									<?php echo $clie['DOMICILIOS'] ?>
								    </a>
                            </td>
        ...
        <button type="submit" class="btn hvr-hover" name="btnActCliente" id="btnActCliente" style="color: aliceblue; height:50px; width:150px" data-toggle="modal" data-target="#insertarModalCliente"><i class="fas fa-user-plus"></i> Añadir Cliente</button>
        <button type="submit" class="btn hvr-hover" name="btnActCliente" id="btnActCliente" style="color: aliceblue; height:50px; width:150px" data-toggle="modal" data-target="#actualizarModalCliente"><i class="fas fa-user-edit"></i> Actualizar Cliente</button>
    </div>           
    ...
    <!-- ALL PLUGINS -->
    <?php require_once "modalActClie.php" ?>
    <?php require_once "modalInsCli.php" ?>
