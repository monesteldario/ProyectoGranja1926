            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="gallery.php">Galería de Imágenes</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>Galería</h1>
                        <p>Acá podrás encontrar fotos de nuestro día a día en la granja.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            <button class="active" data-filter="*">Todas las imágenes.</button>
                            <button data-filter=".bulbs">Gallinas</button>
                            <button data-filter=".fruits">Comida</button>
							<button data-filter=".podded-vegetables">Granja</button>
							<button data-filter=".root-and-tuberous">Huevos</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row special-list">
                <div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="images/gallinasdemo.png" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid fruits">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/gag-comida.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/gag-gallinas.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid fruits">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/gag-gcomiendo.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
				...
				<div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/gallinasAlimentando.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid fruits">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/gag-comiendoG.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid podded-vegetables">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/gag-granja.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid root-and-tuberous">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/huevosdemo1.png" class="img-fluid" alt="Image">
                            <div class="mask-icon">
				...
				<div class="col-lg-3 col-md-6 special-grid root-and-tuberous">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/gag-huevos1.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid podded-vegetables">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/gag-granja1.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid root-and-tuberous">
                    <div class="products-single fix">
                        <div class="box-img-hover">                           
                            <img src="images/gag-huevos2.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                ...
                <div class="col-lg-3 col-md-6 special-grid podded-vegetables">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/gag-granja2.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
